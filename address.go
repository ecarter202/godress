...
func IsState(s string) bool {
	...
	for _, value := range possibleStates {
...
func IsStreetType(s string) bool {
	possibleStreetTypes := []string{"ALY", "ANX", "AVE", "BLVD", "CIR", "CT", "CV", "CRES", "DR", "EXPY", "EXT", "GRV", "HWY", "HL", "KY", "LN", "LOOP", "MALL", "PARK", "PKWY", "PL", "PLZ", "PT", "RD", "ROW", "RUN", "SQ", "ST", "TER", "TRCE", "TRL", "WAY", "ZZ"}

	for _, value := range possibleStreetTypes {
		if strings.ToUpper(s) == value {
			return true
		}
	}
...
func IsStreetDirection(s string) bool {
	possibleStreetDirections := []string{"N", "NW", "NE", "S", "SW", "SE", "E", "W"}

	for _, value := range possibleStreetDirections {
		if strings.ToUpper(s) == value {
			return true
		}
	}
